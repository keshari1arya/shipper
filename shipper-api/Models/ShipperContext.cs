...
public partial class ShipperContext : DbContext
{
    public ShipperContext()
    {
    }

    public ShipperContext(DbContextOptions<ShipperContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<ShipperShipmentDetails_Result> ShipperShipmentDetails_Results { get; set; }
    ...
    public IEnumerable<ShipperShipmentDetails_Result> SP_ShipperShipmentDetails(int shipperId)
    {
        return this.ShipperShipmentDetails_Results
            .FromSqlInterpolated($"Shipper_Shipment_Details {shipperId}")
            .ToArray();
    }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:ShipperDb");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ShipperShipmentDetails_Result>(entity => entity.HasNoKey());
